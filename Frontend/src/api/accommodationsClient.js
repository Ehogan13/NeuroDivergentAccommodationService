...
export default class AccommodationsClient extends BaseClass {
    ...
    async getAllAccommodations(errorCallback) {
            try {
                ...
                console.log("this is from accomodationsclient.js the getAllAccommodations function");
    ...
    async createAccommodation(accessibilityNeed, accommodation, errorCallback) {
